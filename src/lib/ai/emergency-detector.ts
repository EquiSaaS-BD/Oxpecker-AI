...
const EMERGENCY_PATTERNS: {
  ...
  {
    keywords: ['allergic reaction', 'অ্যালার্জি', 'anaphylaxis', 'swelling throat', 'গলা ফুলে', 'hives all over'],
  ...
  {
    keywords: ['baby high fever', 'infant fever', 'বাচ্চার জ্বর', 'শিশুর উচ্চ জ্বর', 'newborn fever'],
