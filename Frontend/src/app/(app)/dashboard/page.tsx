  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 max-w-7xl mx-auto space-y-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-slate-500 mt-1">শুভ সকাল, {userProfile.name.split(' ')[0]}। এখানে আপনার আজকের স্বাস্থ্যের সারসংক্ষেপ।</p>
      </div>
        ...
        <div className="xl:col-span-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6 relative overflow-hidden shadow-sm hover:shadow-md transition-shadow">
              <div className="absolute inset-0  from-secondary-container/20  pointer-events-none"></div>
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between">
              <div>
                ...
                <div className="grid grid-cols-2 gap-4 mt-6">
                  <div className="bg-slate-100-low border border-slate-100 p-4 rounded-xl">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-6">
              ...
              <Link href="#" className="text-sm text-sky-600 font-medium flex items-center hover:underline">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="border border-slate-100 rounded-xl p-4 bg-slate-50">
                ...
                <div className="w-full bg-slate-100 rounded-full h-1.5">
                  <div className="bg-rose-500 h-1.5 rounded-full" ></div>
                </div>
              </div>
              ...
              <div className="border border-slate-100 rounded-xl p-4 bg-slate-50">
                ...
                <div className="w-full bg-slate-100 rounded-full h-1.5">
                  <div className="bg-sky-600 h-1.5 rounded-full" ></div>
                </div>
              </div>
        ...
        <div className="xl:col-span-4 space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="space-y-4">
              {medicineReminders.map((rem: any) => (
                <div key={rem.id} className={`p-4 rounded-xl border ${rem.overdue ? 'border-l-4 border-l-error bg-rose-50/10 border-slate-50' : 'border-slate-100 bg-slate-50'}`}>
                  ...
                  {rem.overdue && (
                    <button className="mt-3 w-full py-1.5 border border-rose-300 text-rose-500 text-sm font-medium rounded-lg hover:bg-rose-50 transition-colors">
                      রিভিউ করুন
                    </button>
                  )}
                </div>
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="flex items-center gap-4 bg-white p-4 rounded-xl border border-slate-100">
              <div className="w-14 h-14 bg-sky-50 rounded-xl flex flex-col items-center justify-center text-sky-900 shrink-0 shadow-sm border border-sky-200">
              ...
              <div>
                <h4 className="font-bold text-slate-900">{upcomingAppointment.doctorName}</h4>
                <p className="text-sm text-slate-500 mb-1">{upcomingAppointment.specialty}</p>
