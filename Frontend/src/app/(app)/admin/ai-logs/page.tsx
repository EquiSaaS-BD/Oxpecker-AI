...
const DEMO_LOGS: LogEntry[] = [
  ...
  },
  {
    ...
    responsePreview: " EMERGENCY: Your symptoms suggest a possible cardiac event...",
  ...
  },
  {
    ...
    responsePreview: " ইমার্জেন্সি: আপনার লক্ষণগুলো হৃদরোগের ইঙ্গিত...",
  ...
  return (
    <div className="p-6 md:p-8 max-w-[1200px] mx-auto space-y-6">
            ...
            >
              ...
              <div className="flex items-center gap-3 p-4">
                ...
                <div className="w-[120px] shrink-0 hidden md:block">
                  ...
                  <p className="text-[11px] text-slate-500">{timeAgo(log.timestamp)}</p>
                </div>
                ...
                {/* Meta */}
                <div className="hidden lg:flex items-center gap-4 text-[12px] text-slate-500 shrink-0">
              ...
              {isExpanded && (
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <p className="text-[11px] font-bold text-slate-500 uppercase tracking-wider mb-1">AI Response Preview</p>
      ...
      <div className="flex items-center justify-between pt-4">
        <p className="text-[13px] text-slate-500">Showing 1-{filteredLogs.length} of {filteredLogs.length} entries</p>
        <div className="flex gap-1">
          <button className="w-9 h-9 rounded-lg border border-slate-200 flex items-center justify-center text-slate-500 hover:bg-slate-50 disabled:opacity-30" disabled>
            <ChevronLeft size={16} />
          </button>
          <button className="w-9 h-9 rounded-lg bg-sky-600 text-white flex items-center justify-center font-bold text-[13px]">1</button>
          <button className="w-9 h-9 rounded-lg border border-slate-200 flex items-center justify-center text-slate-500 hover:bg-slate-50 disabled:opacity-30" disabled>
