      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white border border-slate-200 rounded-2xl p-6">
          <h3 className="text-[16px] font-bold text-slate-700 mb-6 flex items-center gap-2">
            <BarChart3 size={18} className="text-primary" /> Weekly Requests
          </h3>
            ...
            {WEEKLY_DATA.map((d, i) => (
              <div key={i} className="flex-1 flex flex-col items-center gap-2">
                ...
                <motion.div
                  ...
                  className="w-full bg-gradient-to-t from-primary/80 to-primary/40 rounded-t-xl min-h-[8px]"
                />
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6">
          <h3 className="text-[16px] font-bold text-slate-700 mb-6 flex items-center gap-2">
            <Activity size={18} className="text-primary" /> Provider Usage
          </h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6">
          <h3 className="text-[16px] font-bold text-slate-700 mb-4 flex items-center gap-2">
            <TrendingUp size={18} className="text-primary" /> Popular Topics
          </h3>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6">
          <h3 className="text-[16px] font-bold text-slate-700 mb-4 flex items-center gap-2">
            <Globe size={18} className="text-primary" /> Language Distribution
          </h3>
          <div className="space-y-4">
            {LANGUAGES.map((l, i) => (
