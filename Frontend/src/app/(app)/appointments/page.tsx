           ...
           <div className="w-full flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
             ...
             <div className="w-full min-h-[400px] bg-white rounded-[32px] shadow-[0_20px_60px_rgba(0,0,0,0.04)] border border-slate-100 p-5 md:p-8 flex flex-col gap-8">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                 <div className="h-[88px] bg-gradient-to-br from-emerald-500/10 to-emerald-500/5 rounded-[24px] border border-emerald-500/20 flex flex-col justify-center px-6 relative overflow-hidden group">
                 ...
                 <div className="h-[88px] bg-slate-900 rounded-[24px] shadow-inner flex flex-col justify-center items-center relative overflow-hidden">
                   <div className="absolute inset-0 opacity-20 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-emerald-400 via-transparent to-transparent blur-xl"></div>
            ...
            <div className="flex flex-col gap-4">
              {mockHistoryAppointments.map((apt, idx) => (
                <div key={idx} className="bg-white border border-slate-200/80 rounded-[24px] p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5 hover:shadow-[0_10px_30px_rgba(0,0,0,0.04)] hover:border-slate-300 transition-all cursor-pointer group">
                  ...
                  <div className="flex items-center gap-5">
                    {/* Date Bubble */}
                    <div className="w-[72px] h-[72px] rounded-[20px] bg-slate-50 border border-slate-100 flex flex-col items-center justify-center shrink-0 group-hover:bg-primary/5 group-hover:border-primary/20 transition-colors">
                      <span className="text-[24px] font-[900] text-slate-800 leading-none group-hover:text-primary transition-colors">{apt.date.split(' ')[0]}</span>
