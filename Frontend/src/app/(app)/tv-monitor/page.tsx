    ...
    <div className="w-full h-screen bg-slate-50 text-slate-900 flex flex-col md:flex-row overflow-hidden font-sans select-none">
      ...
      <div className="w-full md:w-[60%] h-[50vh] md:h-full bg-white flex flex-col relative overflow-hidden border-b md:border-b-0 md:border-r border-slate-200">
        ...
        <div className="p-8 md:p-12 flex items-center gap-4 relative z-10">
          <div className="w-12 h-12 md:w-16 md:h-16 bg-white rounded-2xl flex items-center justify-center shadow-md">
            <span className="text-slate-900 font-black text-[24px] md:text-[32px] leading-none">O</span>
          </div>
          <div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center relative z-10">
          ...
          {activePatient ? (
            ...
            <div className="text-center">
              <h2 className="text-[60px] md:text-[80px] font-black text-slate-600 leading-none tracking-tight mb-4">
                No active patient
              </h2>
            </div>
          )}
        ...
        <div className="p-8 md:p-12 relative z-10 flex justify-between items-end">
          ...
          <div className="text-right hidden sm:block">
            <p className="text-slate-500 text-sm font-medium">Please wait for your token number</p>
            <p className="text-slate-500 font-bold text-lg" suppressHydrationWarning>{new Date().toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit' })}</p>
          </div>
        </div>
      </div>
