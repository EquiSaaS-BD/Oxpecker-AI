      ...
      <div className="relative z-10 px-4 sm:px-6 lg:px-8 max-w-[1200px] mx-auto w-full mt-2 lg:mt-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-[20px] lg:rounded-[24px] p-6 shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-white/60 flex flex-col gap-6 relative overflow-hidden group">
              <div className="flex flex-col sm:flex-row lg:flex-col items-center lg:items-start gap-4">
                <div className="relative w-16 h-16 lg:w-20 lg:h-20 rounded-full bg-slate-100 flex items-center justify-center shrink-0 border-[3px] border-white shadow-md overflow-hidden group/avatar">
                  <Image 
                    src={profileImage || user?.image || "https://api.dicebear.com/7.x/avataaars/svg?seed=Felix&backgroundColor=e0f2fe"} 
                  ...
                  {/* Upload Overlay */}
                  <ImageUploadCropper 
                  onUpload={(base64) => { setProfileImage(base64); toast.success("Photo cropped & added! Click Save."); }}
                  buttonText=""
                  icon={<Camera size={20} className="text-slate-900" />}
                  className="absolute inset-0 bg-white/40 flex items-center justify-center opacity-0 group-hover/avatar:opacity-100 transition-opacity cursor-pointer backdrop-blur-sm"
                />
                </div>
          ...
          <div className="lg:col-span-8 pb-12 lg:pb-0">
                  ...
                  <>
                    <div className="bg-white/80 backdrop-blur-xl rounded-[20px] lg:rounded-[24px] p-6 lg:p-8 shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-white/60 transition-all">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                          <label className="text-[12px] font-bold text-slate-500 uppercase tracking-wider block mb-1">Full Name</label>
                          {isIdentityEditMode ? (
                            <input 
                              type="text" 
                              value={editForm.name}
                        ...
                        <div>
                          <label className="text-[12px] font-bold text-slate-500 uppercase tracking-wider block mb-1">Email Address</label>
                          {isIdentityEditMode ? (
                            <input 
                              type="email" 
                        ...
                        <div>
                          <label className="text-[12px] font-bold text-slate-500 uppercase tracking-wider block mb-1">Phone Number</label>
                          {isIdentityEditMode ? (
                            <input 
                              type="text" 
                        ...
                        <div>
                          <label className="text-[12px] font-bold text-slate-500 uppercase tracking-wider block mb-1">Assistant ID (Read-only)</label>
                      ...
                      {verificationStep === 'select' && (
                        <div>
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            >
                              <FileText className="text-slate-500 group-hover:text-[#2F80ED] mb-3" size={28} />
                            ...
                            <button 
                              ...
                              className="p-5 border-2 border-slate-100 rounded-[16px] text-left hover:border-[#2F80ED] hover:bg-blue-50/30 transition-all group"
                            >
                              <Globe className="text-slate-500 group-hover:text-[#2F80ED] mb-3" size={28} />
                      ...
                      {verificationStep === 'upload' && (
                        <div>
                          <div className="flex items-center gap-3 mb-6">
                            <button onClick={() => setVerificationStep('select')} className="text-slate-500 hover:text-slate-700">
                          ...
                          <div className="mt-6 flex gap-3">
                            ...
                            <button 
                              ...
                              className={`flex-1 px-4 py-3 font-bold rounded-xl flex items-center justify-center gap-2 transition-all shadow-md ${uploadedFileName ? 'bg-[#2F80ED] text-white hover:bg-blue-600 active:scale-95' : 'bg-slate-200 text-slate-500 cursor-not-allowed'}`}
                            >
                              Submit Document
                            </button>
                          </div>
            ...
            <p className="text-center text-[13px] text-slate-500 font-medium py-8 pb-12">
              Oxpecker AI App v1.2.0 • Production Level
            </p>
