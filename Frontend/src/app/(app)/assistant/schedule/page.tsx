              ...
              <div className="flex flex-col md:flex-row">
                ...
                <div className="flex-1 p-5 flex flex-col gap-4">
                  {daySchedule.chambers.length === 0 ? (
                    <div className="h-full min-h-[80px] flex items-center justify-center text-[14px] font-medium text-slate-500 bg-slate-50 rounded-xl border border-dashed border-slate-200">
                      Off Day / No Schedule
                    </div>
                  ) : (
