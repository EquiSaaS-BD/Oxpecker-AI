          ...
          filteredChambers.map((chamber, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div className="absolute right-0 top-0 w-[40%] h-full bg-gradient-to-l from-indigo-50/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none" />
                  ...
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-all ${isExpanded ? 'bg-indigo-600 text-white rotate-180' : 'bg-slate-50 text-slate-400 group-hover:bg-indigo-50 group-hover:text-indigo-600'}`}>
                    <ChevronDown size={20} />
                  </div>
                </div>
                ...
                <div className="bg-white rounded-[16px] shadow-sm border border-slate-100 overflow-hidden mb-6">
                  ...
                  <div className="p-4 space-y-4">
                    ...
                    <div className="flex justify-between items-center text-[14px]">
                      ...
                      <span className="font-bold text-slate-800">{new Date(billingPatient.date).toLocaleDateString()}</span>
                    </div>
