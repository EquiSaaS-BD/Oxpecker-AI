    ...
    <div className="w-full h-full overflow-y-auto bg-[#F8FAFC] font-sans pb-[100px] lg:pb-10 relative">
        ...
        <div className="flex-1 min-w-0 w-full max-w-[1280px] space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 grid grid-cols-2 gap-4 h-[280px]">
              ...
              <StatCard icon={<Target className="text-sky-600" />} title="Weight" value="72.5" target="kg" color="bg-[#6DDA6E]/10" />
            </div>
          </div>
          ...
          <div className="bg-white rounded-[18px] p-6 border border-[#E5E7EB] shadow-[0_8px_30px_rgb(0,0,0,0.04)] h-[320px] flex flex-col">
            ...
            <div className="flex-1 border-2 border-dashed border-slate-200 rounded-[16px] bg-slate-50 hover:bg-[#6DDA6E]/5 hover:border-[#6DDA6E]/50 transition-colors flex flex-col items-center justify-center cursor-pointer group">
              <div className="flex gap-4 mb-6">
                <button className="w-14 h-14 bg-white rounded-full shadow-sm flex items-center justify-center text-slate-600 group-hover:text-sky-600 transition-colors border border-slate-100"><Camera size={24} /></button>
                <button className="w-14 h-14 bg-white rounded-full shadow-sm flex items-center justify-center text-slate-600 group-hover:text-sky-600 transition-colors border border-slate-100"><ImageIcon size={24} /></button>
              </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <button className="text-sky-600 font-bold text-[14px] flex items-center gap-1"><Plus size={16} /> Add Meal</button>
            </div>
        ...
        <div className="hidden lg:block w-[340px] shrink-0">
          <div className="sticky top-[100px] space-y-6">
            ...
            <div className="bg-white rounded-[18px] p-6 border border-[#E5E7EB] shadow-[0_8px_30px_rgb(0,0,0,0.04)] text-center relative overflow-hidden">
              ...
              <button className="w-full py-3 bg-sky-600 hover:bg-[#5bc25c] text-white font-bold rounded-xl transition-colors shadow-md shadow-primary/20">
                Book Appointment
              </button>
            </div>
      ...
      <div className="lg:hidden fixed bottom-0 left-0 w-full h-[74px] bg-white border-t border-[#E5E7EB] px-4 flex items-center justify-between z-50 shadow-[0_-8px_30px_rgb(0,0,0,0.04)] pb-safe">
        ...
        <div className="flex flex-col items-center">
          ...
          <span className="text-[18px] font-[800] text-sky-600">92</span>
        </div>
        <button className="h-[44px] px-6 bg-sky-600 text-white font-bold rounded-xl shadow-md shadow-primary/20">
          Book Expert
        </button>
      </div>
  ...
  <div className="bg-white rounded-[18px] p-5 border border-[#E5E7EB] shadow-[0_8px_30px_rgb(0,0,0,0.04)] h-[220px] flex flex-col">
    <div className="flex justify-between items-start mb-3">
      ...
      <div className="flex gap-2">
        <button className="text-slate-400 hover:text-sky-600 transition-colors"><Edit2 size={14} /></button>
...
const GoalCard = ({ title, active }: any) => (
  <div className={`h-[130px] rounded-[18px] border-2 flex flex-col items-center justify-center p-4 cursor-pointer transition-all ${active ? 'border-primary bg-sky-600/5 shadow-md shadow-primary/10' : 'border-[#E5E7EB] bg-white hover:border-slate-300'}`}>
    <Target size={28} className={`mb-3 ${active ? 'text-sky-600' : 'text-slate-400'}`} />
