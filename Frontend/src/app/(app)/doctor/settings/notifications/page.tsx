...
export default function NotificationsSettingsPage() {
  ...
  const ToggleSwitch = ({ checked, onChange }: { checked: boolean, onChange: () => void }) => (
    <button 
      onClick={onChange}
      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none ${checked ? 'bg-[#2F80ED]' : 'bg-slate-700'}`}
    >
      <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform shadow-none ${checked ? 'translate-x-6' : 'translate-x-1'}`} />
    </button>
  );
    ...
    <div className="space-y-8 animate-fade-in-up pb-20">
      ...
      <div className="bg-white rounded-[24px] shadow-none border border-slate-300 p-6 lg:p-8">
        <div className="flex justify-between items-start md:items-center">
          ...
          <button 
            onClick={handleSave}
            disabled={isSaving}
            className="px-6 py-2.5 bg-slate-800 hover:bg-slate-700 text-white font-bold rounded-xl shadow-none transition-all flex items-center gap-2"
          >
            {isSaving ? (
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-[24px] shadow-none border border-slate-300 overflow-hidden w-full">
            ...
            <div className="p-2">
              <div className="p-4 flex items-center justify-between border-b border-slate-200">
                <div>
                  <h4 className="text-[14px] font-bold text-slate-700">New Appointments</h4>
              ...
              <div className="p-4 flex items-center justify-between border-b border-slate-200">
                <div>
                  <h4 className="text-[14px] font-bold text-slate-700">Assistant Messages</h4>
              ...
              <div className="p-4 flex items-center justify-between">
                <div>
                  <h4 className="text-[14px] font-bold text-slate-700">Platform Updates</h4>
                  <p className="text-[13px] text-slate-500 mt-0.5">Receive news about new Oxpecker AI features.</p>
                </div>
          ...
          <div className="bg-white rounded-[24px] shadow-none border border-slate-300 overflow-hidden w-full">
            ...
            <div className="p-2">
              <div className="p-4 flex items-center justify-between border-b border-slate-200">
                <div>
                  <h4 className="text-[14px] font-bold text-slate-700">Appointment Confirmation</h4>
              ...
              <div className="p-4 flex items-center justify-between">
                <div>
                  <h4 className="text-[14px] font-bold text-slate-700">Daily Schedule Reminder</h4>
        ...
        <div className="space-y-8">
          ...
          {/* Email Notifications */}
          <div className="bg-white rounded-[24px] shadow-none border border-slate-300 overflow-hidden w-full">
            <div className="p-6 border-b border-slate-200 bg-[#F59E0B]/5">
              <h3 className="text-[16px] font-bold text-slate-700 flex items-center gap-2">
            ...
            <div className="p-2">
              <div className="p-4 flex items-center justify-between border-b border-slate-200">
                <div>
                  <h4 className="text-[14px] font-bold text-slate-700">Daily Summary</h4>
              ...
              <div className="p-4 flex items-center justify-between border-b border-slate-200">
                <div>
                  <h4 className="text-[14px] font-bold text-slate-700">Weekly Analytics</h4>
              ...
              <div className="p-4 flex items-center justify-between">
                <div>
                  <h4 className="text-[14px] font-bold text-slate-700">Marketing & Offers</h4>
          ...
          {/* System Preferences */}
          <div className="bg-white rounded-[24px] shadow-none border border-slate-300 overflow-hidden w-full">
            <div className="p-6 border-b border-slate-200 bg-[#10B981]/5">
              <h3 className="text-[16px] font-bold text-slate-700 flex items-center gap-2">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="text-[14px] font-bold text-slate-700">Dashboard Sound</h4>
              ...
              <div>
                <label className="block text-[14px] font-bold text-slate-700 mb-1.5 flex items-center gap-2">
                ...
                <select 
                  ...
                  className="w-full h-[48px] bg-slate-50 border border-slate-300 rounded-xl px-4 text-[14px] text-slate-700 font-semibold focus:outline-none focus:border-[#2F80ED] transition-all cursor-pointer"
                >
