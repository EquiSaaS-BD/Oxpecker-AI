...
export default function DisclaimerPage() {
  return (
    <PageLayout title="Medical Disclaimer" breadcrumb="Disclaimer" lastUpdated="July 15, 2026">
      ...
      <p>
        The content provided by Oxpecker, including the AI symptom analysis, is for informational purposes only and does not constitute professional medical advice, diagnosis, treatment, or recommendations of any kind.
      </p>
      ...
      <h2>Emergencies</h2>
      <p>
        If you think you may have a medical emergency, call your doctor or emergency services immediately. Oxpecker does not recommend or endorse any specific tests, physicians, products, procedures, or opinions.
      </p>
    </PageLayout>
  );
}
