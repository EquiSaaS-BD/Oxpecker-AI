...
export default function TermsPage() {
  return (
    <PageLayout title="Terms of Use" breadcrumb="Terms" lastUpdated="July 15, 2026">
      ...
      <p>
        By accessing and using Oxpecker, you agree to be bound by these Terms of Use and our Privacy Policy. If you do not agree to these terms, please do not use our services.
      </p>
