...
<div className="w-8 h-8 rounded-full bg-primary text-on-primary flex items-center justify-center font-label-md font-bold transition-colors shadow-md">২</div>
...
<div className="flex-grow space-y-md" id="step-2">
<div>
