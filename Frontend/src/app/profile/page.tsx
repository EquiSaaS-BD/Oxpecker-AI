        ...
        <div className="bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden">
          ...
          <div className="bg-white px-8 py-10 text-slate-900 flex flex-col sm:flex-row items-center gap-6 relative">
            ...
            <div className="text-center sm:text-left">
              ...
              <p className="text-slate-600 mt-1 capitalize font-medium flex items-center justify-center sm:justify-start gap-2 text-sm">
                <UserCog size={15} />
                {role} Profile
              </p>
              <p className="text-xs text-slate-500 mt-1 font-mono">{formData.email || user?.email}</p>
            </div>
          </div>
          ...
          <div className="p-8 sm:p-10">
            ...
            <div className="flex justify-end pt-4 border-t border-slate-100">
              <button
                onClick={handleSave}
                disabled={isSaving}
                className="flex items-center gap-2 px-6 h-12 bg-white hover:bg-slate-50 disabled:bg-slate-700 text-slate-900 font-bold rounded-xl transition-all shadow-sm text-sm"
              >
                {isSaving ? (
