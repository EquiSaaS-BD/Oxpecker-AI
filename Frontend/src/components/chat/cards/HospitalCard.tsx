  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-4">
        <div className="shrink-0 w-14 h-14 rounded-full bg-emerald-50 border border-emerald-200 flex items-center justify-center shadow-sm">
      ...
      <div className="flex gap-2.5">
        <motion.a
          ...
          whileTap={{ scale: 0.97 }}
          className="flex-1 flex items-center justify-center gap-2 bg-[#09E083] hover:bg-[#07c972] text-slate-900 font-semibold py-2.5 px-4 rounded-xl text-sm transition-colors cursor-pointer no-underline"
        >
