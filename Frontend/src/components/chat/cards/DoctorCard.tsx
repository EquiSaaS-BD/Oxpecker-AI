  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-4">
        {/* Avatar */}
        <div className="shrink-0 w-14 h-14 rounded-full bg-sky-100 border border-sky-200 flex items-center justify-center text-sky-700 font-bold text-lg shadow-sm">
      ...
      <div className="flex gap-2.5">
        <motion.button
          ...
          whileTap={{ scale: 0.97 }}
          className="flex-1 flex items-center justify-center gap-2 bg-[#09E083] hover:bg-[#07c972] text-slate-900 font-semibold py-2.5 px-4 rounded-xl text-sm transition-colors cursor-pointer"
        >
