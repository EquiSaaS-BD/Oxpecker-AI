      ...
      <div className="flex-1 overflow-y-auto p-6">
        <div className="max-w-[1200px] mx-auto w-full flex flex-col gap-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between py-2">
            <div>
              <h1 className="text-[22px] sm:text-[24px] font-bold text-slate-800 tracking-tight">Preferred Medicines</h1>
            ...
            <div className="flex items-center gap-3 w-full sm:w-auto">
              <div className="relative flex-1 sm:w-[280px]">
                ...
                <input 
                  ...
                  className="w-full h-[40px] pl-9 pr-4 bg-white border border-slate-200 rounded-xl text-[14px] text-slate-700 outline-none focus:border-sky-500 shadow-xs transition-all"
                />
              </div>
              <button className="h-[40px] px-5 bg-sky-600 hover:bg-sky-700 text-white rounded-xl text-[14px] font-bold flex items-center gap-2 shadow-xs transition-colors shrink-0">
                <Plus size={16} />
                Add Medicine
              </button>
            </div>
              ...
              {mockMedicines.map((med) => (
                ...
                >
                  ...
                  <div className="w-[10%] flex items-center justify-end gap-2">
                    <button aria-label="Edit medicine" className="w-8 h-8 flex items-center justify-center text-slate-500 hover:text-[#2F80ED] hover:bg-blue-50 rounded-lg transition-colors opacity-0 group-hover:opacity-100">
                      <Edit2 size={16} />
                    </button>
                    <button aria-label="Delete medicine" className="w-8 h-8 flex items-center justify-center text-slate-500 hover:text-red-500 hover:bg-red-50 rounded-lg transition-colors opacity-0 group-hover:opacity-100">
                      <Trash2 size={16} />
                    </button>
                  </div>
                </div>
