...
export function PrescriptionFinalizeModal({ isOpen, onClose }: PrescriptionFinalizeModalProps) {
  ...
  return createPortal(
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-[99999] flex items-center justify-center p-0 sm:p-6 bg-white/40 backdrop-blur-sm">
          <motion.div
        ...
        >
          ...
          <div className="bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between shrink-0">
            ...
            <button onClick={onClose} className="p-2 text-slate-500 hover:text-slate-600 hover:bg-slate-50 rounded-xl transition-colors">
              <X size={20} />
            </button>
          </div>
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-5 mb-4 shadow-sm">
                <div className="flex justify-between items-start mb-4 pb-4 border-b border-slate-100">
                  ...
                  <div className="text-right">
                    ...
                    <p className="font-bold text-slate-800" suppressHydrationWarning>{new Date().toLocaleDateString('en-GB')}</p>
                  </div>
                </div>
            ...
            <div className="w-full md:w-[350px] flex flex-col gap-4">
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm flex flex-col gap-3 mt-auto">
                <button 
                  ...
                  className="w-full py-3.5 rounded-xl font-bold text-slate-900 bg-[#6DDA6E] shadow-[0_4px_16px_rgba(109,218,110,0.25)] hover:bg-[#5bc95c] transition-all hover:-translate-y-0.5 text-base flex justify-center items-center gap-2"
                >
