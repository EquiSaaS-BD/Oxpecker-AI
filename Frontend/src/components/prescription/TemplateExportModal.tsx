        ...
        <div className="flex-1 overflow-y-auto p-6 bg-slate-50 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="border-2 border-[#6DDA6E] bg-white rounded-xl p-4 cursor-pointer relative shadow-sm">
                ...
                <div className="w-full h-32 bg-slate-50 border border-slate-100 rounded-lg mb-3 flex items-center justify-center">
                  <Image src="/images/Oxpecker_icon.png" width={32} height={32} alt="Logo" className="opacity-50 grayscale" />
                </div>
                <h4 className="font-bold text-slate-800 text-sm">Oxpecker Standard</h4>
              ...
              <div className="border border-slate-200 bg-white rounded-xl p-4 cursor-pointer hover:border-[#2F80ED] transition-colors relative">
                <div className="w-full h-32 bg-slate-50 border border-slate-100 rounded-lg mb-3 flex items-center justify-center overflow-hidden relative">
                  ...
                  <span className="text-xs font-bold text-slate-500">Green View Hospital</span>
                </div>
              ...
              <div className="border border-slate-200 bg-white rounded-xl p-4 cursor-pointer hover:border-[#2F80ED] transition-colors relative">
                <div className="w-full h-32 bg-slate-50 border border-slate-100 rounded-lg mb-3 flex items-center justify-center">
                  <span className="text-xs font-bold text-slate-500">Dr. Patient's Pad</span>
                </div>
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-5 flex flex-col h-full shadow-sm">
            ...
            <div className="flex-1 flex flex-col gap-3">
              <button className="w-full bg-[#6DDA6E] hover:bg-[#5bc95c] text-slate-900 font-bold py-3.5 px-4 rounded-xl flex items-center justify-center gap-2 transition-all shadow-md active:scale-95">
                <FileDown size={20} />
                Download PDF
              </button>
              
              <button className="w-full bg-slate-800 hover:bg-slate-700 text-white font-bold py-3.5 px-4 rounded-xl flex items-center justify-center gap-2 transition-all shadow-md active:scale-95">
                <Printer size={20} />
                Direct Print
              </button>
            </div>
            ...
            <div className="mt-6 pt-6 border-t border-slate-100">
              <h4 className="text-xs font-bold uppercase text-slate-500 tracking-wider mb-3">After Export</h4>
              <label className="flex items-start gap-3 cursor-pointer group">
                <div className="relative flex items-center justify-center mt-0.5 shrink-0">
                  ...
                  <CheckCircle2 size={14} className="text-slate-900 absolute opacity-0 peer-checked:opacity-100 transition-opacity" />
                </div>
