  ...
  return (
    <footer className="relative bg-slate-50 border-t border-slate-200">
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        ...
        <div id="partners" className="py-14 sm:py-16 border-b border-slate-200">
          <div className="flex items-center justify-between mb-8">
            <div>
              <span className="text-sky-600 font-bold text-xs tracking-widest uppercase">
                Network of Trust
              </span>
              <h3 className="text-slate-900 text-lg sm:text-xl font-extrabold mt-2 tracking-tight">
          ...
          <div className="oxpecker-marquee-mask relative overflow-hidden">
            <div className="flex gap-4 oxpecker-marquee-track w-max">
              {[...PARTNER_CLINICS, ...PARTNER_CLINICS].map((name, i) => (
                <div
                  key={i}
                  className="flex items-center gap-2.5 px-5 py-3 rounded-xl bg-white border border-slate-200 whitespace-nowrap hover:bg-slate-50 hover:border-slate-300 shadow-sm transition-colors duration-300"
                >
        ...
        <div className="py-14 sm:py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-4 space-y-5">
            ...
            />
            <p className="text-sm font-medium leading-relaxed text-slate-500 max-w-[320px]">
              Oxpecker is an AI-powered healthcare platform: offering symptom analysis, expert doctor connections, and verified drug information, completely free.
            </p>
            ...
            <div className="flex items-center gap-2.5 pt-1">
              {[Facebook, Youtube, Instagram, Linkedin].map((Icon, i) => (
                <a
                  ...
                  className="w-9 h-9 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-slate-400 hover:text-sky-600 hover:bg-sky-50 hover:border-sky-200 shadow-sm transition-all duration-300"
                >
                  <Icon size={15} />
                </a>
              ))}
          ...
          <div className="lg:col-span-2 space-y-4">
            <h4 className="text-slate-900 font-bold text-sm tracking-wide">Contact</h4>
            <div className="space-y-3 text-sm font-medium">
              <p className="flex items-start gap-2.5 text-slate-500">
                <MapPin size={15} className="shrink-0 mt-0.5 text-slate-400" /> Dhaka, Bangladesh
              </p>
              <a href="tel:16263" className="flex items-center gap-2.5 text-slate-500 hover:text-slate-900 transition-colors duration-200">
                <PhoneCall size={15} className="shrink-0 text-slate-400" /> 16263 (24/7)
              </a>
              <a
                href="mailto:support@oxpecker.com"
                className="flex items-center gap-2.5 text-slate-500 hover:text-slate-900 transition-colors duration-200"
              >
                <Mail size={15} className="shrink-0 text-slate-400" /> support@oxpecker.com
              </a>
            </div>
          </div>
        </div>
        ...
        {/* ── Bottom Bar ── */}
        <div className="py-6 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs font-semibold text-slate-400">
          <p className="flex flex-wrap items-center gap-1">
            <span>&copy; {new Date().getFullYear()} Oxpecker.</span>
            <span>All rights reserved.</span>
            <span className="text-slate-300">|</span>
            <span>Built by <strong>Team Oxpecker AI</strong> at</span>
            <a 
