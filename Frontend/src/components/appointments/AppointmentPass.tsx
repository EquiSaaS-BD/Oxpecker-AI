...
export function AppointmentPass({ data }: { data: PassData }) {
  ...
  return (
    <div className="bg-white rounded-[24px] shadow-sm border border-slate-200 overflow-hidden mb-8 relative">
      ...
      {/* Top Banner */}
      <div className={`h-24 ${isBed ? 'bg-[#003d9b]' : 'bg-white'} relative overflow-hidden flex items-center px-6 md:px-8`}>
        <div className="absolute right-0 top-0 opacity-10 pointer-events-none">
          <QrCode size={120} className="-mr-4 -mt-4" />
        </div>
        <div className="flex items-center gap-3 relative z-10 text-slate-900 w-full">
          ...
          <div>
            ...
            <p className="text-[13px] text-slate-900/70 font-medium">Booking ID: {data.id}</p>
          </div>
      ...
      <div className="p-6 md:p-8">
        ...
        <div className="flex justify-between items-start mb-8">
          ...
          <div className="hidden sm:flex flex-col items-center justify-center p-2 border-2 border-slate-100 rounded-xl bg-white shadow-sm">
            ...
            <span className="text-[10px] font-[800] text-slate-500 uppercase tracking-widest">Scan Me</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div>
            <h4 className="text-[11px] font-[800] text-slate-500 uppercase tracking-wider mb-3">Patient Details</h4>
          ...
          <div>
            <h4 className="text-[11px] font-[800] text-slate-500 uppercase tracking-wider mb-3">Location</h4>
        ...
        <div className="  to-slate-100/50 rounded-[20px] p-6 mb-8 border border-slate-200 shadow-sm relative overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <button className="flex-1 h-12 bg-white hover:bg-slate-50 text-slate-900 rounded-[12px] font-bold text-[14px] transition-colors flex items-center justify-center gap-2">
