...
import {
  ...
  Camera, Sparkles, ChevronRight, AlertTriangle, RefreshCw,
...
export function DoctorAIAssistant({
  ...
  return (
    <>
      ...
      >
        {/* Header */}
        <div className="h-[72px] px-5 border-b border-slate-100 flex items-center justify-between bg-gradient-to-r from-blue-50 to-indigo-50 shrink-0">
