  ...
  return (
    <div className="p-6 space-y-6 animate-pulse">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[...Array(4)].map((_, i) => (
          <div key={i} className="bg-white rounded-xl border border-slate-300/80 p-5">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        {/* Table Skeleton */}
        <div className="xl:col-span-2 bg-white rounded-xl border border-slate-300/80 p-5">
        ...
        <div className="bg-white rounded-xl border border-slate-300/80 p-5">
