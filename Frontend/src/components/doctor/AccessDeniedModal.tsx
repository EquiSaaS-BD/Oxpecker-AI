    ...
    <div className="fixed inset-0 z-[100] bg-[#f8fafc] flex items-center justify-center">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div 
          ...
          className="absolute -top-[20rem] -right-[10rem] w-[50rem] h-[50rem]  from-primary/10  rounded-full blur-[100px]"
        />
        <motion.div 
          animate={{ rotate: -360 }}
          transition={{ duration: 200, repeat: Infinity, ease: "linear" }}
          className="absolute -bottom-[20rem] -left-[10rem] w-[40rem] h-[40rem]  from-[#2F80ED]/10  rounded-full blur-[80px]"
        />
      </div>
        ...
        <div className="p-10 flex flex-col items-center text-center">
          ...
          >
            ...
            <motion.div 
              ...
              className="absolute -bottom-2 -right-2 w-10 h-10 bg-white rounded-full shadow-none flex items-center justify-center border border-slate-200"
            >
              <UserCircle2 size={22} className="text-[#2F80ED]" />
            </motion.div>
          </motion.div>

          <h2 className="text-[28px] font-extrabold text-slate-700 mb-3 tracking-tight">Login Required</h2>
          ...
          <button
            onClick={() => router.push("/")}
            className="mt-6 text-[14px] font-bold text-slate-500 hover:text-slate-600 transition-colors"
          >
            Return to Homepage
          </button>
        </div>
