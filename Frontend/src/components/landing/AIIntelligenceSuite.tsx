...
import { Stethoscope, FileText, Pill, Salad, ArrowRight, ShieldAlert, Bot, Activity } from "lucide-react";
...
export function AIIntelligenceSuite() {
  ...
  return (
    <section id="services" className="relative py-16 lg:py-32 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 space-y-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <p className="text-slate-600 text-lg leading-relaxed">
              {t(
                "Simply describe your symptoms and Oxpecker AI provides possible health insights, severity indicators, and recommended specialists using interactive visual cards.",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <Link href="/chat" className="inline-flex items-center gap-2 text-secondary font-bold hover:underline">
