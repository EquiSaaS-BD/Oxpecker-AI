      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl lg:text-5xl font-extrabold text-slate-900 tracking-tight">
            {t("Platform Capabilities", "প্ল্যাটফর্মের মূল সুবিধাসমূহ")}
          </h2>
        </div>
        ...
        <div className="bento-container mb-20">
          ...
          <motion.div
            ...
            className="bento-card md:col-span-2 bg-white text-slate-900 border-slate-200"
          >
             <div className="w-14 h-14 rounded-2xl bg-white/10 flex items-center justify-center mb-6">
                <Bot size={28} className="text-sky-400" />
             </div>
             <h3 className="text-2xl font-bold mb-3">{features[0].title}</h3>
             <p className="text-slate-500 text-lg leading-relaxed max-w-md">{features[0].desc}</p>
          </motion.div>
