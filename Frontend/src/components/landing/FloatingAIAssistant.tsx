  ...
  return (
    <div className="fixed bottom-6 right-6 z-[100] flex flex-col items-end">
          ...
          >
            ...
            <div className="bg-sky-600 p-4 flex justify-between items-center text-white">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-sm">Oxpecker AI</span>
              </div>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.9 }}
        className="w-14 h-14 rounded-full bg-sky-600 hover:bg-sky-700 text-white shadow-xl shadow-sky-600/30 flex items-center justify-center relative group"
      >
