  ...
  return (
    <>
      <section className="relative h-screen min-h-[600px] w-full flex items-center justify-center overflow-hidden bg-black">
        {/* Background Video (Seamless Atmospheric Layer) */}
        <div className="absolute inset-0 z-0 w-full h-full pointer-events-none overflow-hidden bg-[#050b14]">
          <img
            src="/videos/Landing_page_crisp.webp"
            alt="Landing page background animation"
            loading="lazy"
            decoding="async"
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 min-w-full min-h-full w-auto h-auto object-cover opacity-80 brightness-105 scale-105 blur-[1.5px] mix-blend-screen transition-all duration-700"
          />
          {/* Subtle Ambient Radial Vignette & Smooth Bottom Gradient */}
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_30%,#050b14_90%)] opacity-70 pointer-events-none" />
          <div className="absolute inset-0 bg-gradient-to-b from-[#050b14]/20 via-transparent to-[#050b14] pointer-events-none" />
        </div>
