  ...
  const testimonials = [
    {
      ...
      quote: t(
        "Oxpecker AI has completely transformed my family's healthcare. I got advice from the AI even at 2 AM which was perfectly accurate.",
        "Oxpecker AI আমার পরিবারের স্বাস্থ্যসেবা সম্পূর্ণ পাল্টে দিয়েছে। রাত ২টায়ও AI থেকে পরামর্শ পেয়েছি যা একদম সঠিক ছিল।"
      ),
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, i) => (
            <motion.div
              ...
              className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 flex flex-col"
            >
