...
export function ReportsDashboard() {
  ...
  return (
    <div className="flex flex-col h-full bg-[#F8FAFC] relative overflow-hidden">
      <div className={`flex-1 overflow-y-auto p-4 sm:p-6 transition-all duration-300 ease-in-out ${selectedReport ? 'lg:mr-[400px]' : ''}`}>
        <div className="max-w-[1200px] mx-auto w-full flex flex-col gap-6">
          
          {/* 1. Top Action Header */}
          <div className="flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between py-2">
            <h1 className="text-[22px] sm:text-[24px] font-bold text-slate-800 tracking-tight">Reports & Diagnostics</h1>
            ...
            <div className="flex items-center gap-3 w-full sm:w-auto">
              ...
              <button className="h-[40px] px-4 bg-white border border-slate-200 rounded-xl text-[14px] font-medium text-slate-600 flex items-center gap-2 hover:bg-slate-50 transition-colors shadow-xs shrink-0">
                <Filter size={16} />
                Filters
              </button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto">
              {mockReports.map((report) => (
                ...
                >
                  ...
                  <div className="w-[5%] flex justify-end text-slate-500">
