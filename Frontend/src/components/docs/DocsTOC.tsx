...
export function DocsTOC({ content }: DocsTOCProps) {
  ...
  return (
    <aside className="w-[260px] shrink-0 hidden xl:block sticky top-[72px] h-[calc(100vh-72px)] overflow-y-auto pb-20 py-8 pl-8 hide-scrollbar border-l border-slate-100 ">
      <h5 className="text-sm font-semibold text-slate-900  mb-4 uppercase tracking-wider">
        On this page
      </h5>
