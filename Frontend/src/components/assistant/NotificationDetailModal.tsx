...
export function NotificationDetailModal({ isOpen, onClose, notification, onInviteResponse }: NotificationDetailModalProps) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[99999] flex flex-col sm:items-center sm:justify-center bg-white sm:bg-white/40 sm:backdrop-blur-sm sm:p-4 animate-in fade-in duration-200">
        ...
        <div className="flex-1 overflow-y-auto p-5 sm:p-6 custom-scrollbar relative">
          ...
          <div className="flex items-center gap-4 mb-6 pb-6 border-b border-slate-100">
            ...
            <div>
              ...
              <p className="text-[13px] font-medium text-slate-500 mt-1">{notification.time} • Oxpecker AI System</p>
            </div>
          </div>
