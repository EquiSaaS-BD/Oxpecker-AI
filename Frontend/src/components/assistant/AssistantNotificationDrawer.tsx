...
const MOCK_NOTIFICATIONS = [
  ...
  },
  {
    ...
    type: "system",
    title: "System Update",
    message: "The Shustota AI software has been updated to v1.0.0 successfully.",
    time: "Yesterday",
    unread: false
  }
];
...
export function AssistantNotificationDrawer({ isOpen, onClose }: NotificationDrawerProps) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[99999] flex flex-col justify-end sm:items-center sm:justify-center bg-slate-900/40 backdrop-blur-sm animate-in fade-in duration-200">
            ...
            >
              <div className="flex gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[11px] font-bold text-slate-400 uppercase tracking-wider">{notif.time}</p>
                </div>
              </div>
            </div>
          ))}
