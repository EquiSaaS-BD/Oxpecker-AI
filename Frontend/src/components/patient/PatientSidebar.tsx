...
const navItems = [
  ...
  { label: "Medicines", href: "/medicines", icon: ShoppingBag },
    ...
    <>
      ...
      >
        ...
        <div className="h-16 px-6 flex items-center justify-between border-b border-slate-200 shrink-0 bg-white">
          ...
          <button
            onClick={onClose}
            className="lg:hidden p-1.5 text-slate-500 hover:text-slate-600 hover:bg-slate-100 rounded-lg transition-colors"  
          >
            <X size={18} />
          </button>
        </div>
        ...
        <div className="p-6 border-b border-slate-200 shrink-0 bg-white">
          <div className="flex items-center gap-4 mb-2">
            ...
            <div>
              ...
              <p className="text-xs font-semibold text-slate-500 mt-0.5">ID: OX-P-8429</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto py-6 px-4 space-y-1 scrollbar-hide bg-slate-50">
          <div className="px-2 pb-2 text-xs font-bold text-slate-500 uppercase tracking-wider">
            Patient Portal
          </div>
          {navItems.map((item) => {
